...
sample of code to place on github to show what I am capable of as I look for full time ruby on rails development work.
...
than wasting hours on my own design that wouldn't look as well. Besides, those designs cost less than $20. In this application I 
...
== TODO
	...
	-Get domain name setup (.am is taking forever to get registered)
	-Make a mobile version of the login and games#show pages for mobile attendance check in
	-Finish pending tests
	-Finish README
	-Pretty up error pages
	-Spend more that 5 minutes making IE look a little better